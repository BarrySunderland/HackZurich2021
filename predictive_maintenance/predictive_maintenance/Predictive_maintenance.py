...
from .Predictive_maintenance_dialog import Predictive_maintenanceDialog
import os.path
...
class Predictive_maintenance:
    ...
    def __init__(self, iface):
        ...
        locale_path = os.path.join(
            self.plugin_dir,
            'i18n',
            'Predictive_maintenance_{}.qm'.format(locale))
        ...
        self.actions = []
        self.menu = self.tr(u'&predictive maintenance')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('Predictive_maintenance', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/Predictive_maintenance/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'predictive maintenance'),
            callback=self.run,
    ...
    def unload(self):
        ...
        for action in self.actions:
            self.iface.removePluginMenu(
                self.tr(u'&predictive maintenance'),
                action)
    ...
    def run(self):
        ...
        if self.first_start == True:
            ...
            self.dlg = Predictive_maintenanceDialog()
